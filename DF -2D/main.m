...
DIR = [
       1, 20.0000000000000000; #NRO de nodo, valor de T
...
NEU = [
       16, 0, 3; #NRO de nodo, valor del flujo termico, direc del flujo 1-sur 2-este 3-norte 4-oeste
       17, 0, 3;
       18, 0, 3;
       19, 0, 3;
       20, 0, 3;
...
ROB = [
       20, 2, 10, 2; #NRO de nodo, h, phi_inf, direc
       15, 2, 10, 2;
       10, 2, 10, 2;
        5, 2, 10, 2;
];
...
disp('Temperatura en el nodo 10')
disp(PHI(10))
