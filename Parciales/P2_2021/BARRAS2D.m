...
% E = [210e9 210e9 210e9];        % M�dulo de elasticidad por barra/elemento
% area = [6e-4 6e-4 6e-4];        % Areas de cada elemento
% xnod = [0 0 ; 0 4 ; 3 4];       % Coordenadas de cada nodo
% icone = [1 2 ; 1 3];            % conectividad de cada barra
% Desplaz = [-0.05 1 0 0 0 0];                  % Desplazamientos por nodo s cond. borde
% Fuerzas = [0 1e6, 0 0, 0 0];              % Fuerzas aplicadas por nodo
% angulo = [53.13 90];
% L = [];                    % Longitud de cada barra en un vector.
Nele = 2;                             % N�mero de elementos
E = [1e9 1e9];        % M�dulo de elasticidad por barra/elemento
area = [pi*(0.2)^2 pi*(0.1)^2];        % Areas de cada elemento
xnod = [0 0 ; 0 2 ; 1.5*cos(deg2rad(61.04)) 1.5*sin(deg2rad(61.04))];       % Coordenadas de cada nodo
icone = [1 3 ; 2 3];            % conectividad de cada barra
Desplaz = [0 0 0 0 1 1];                  % Desplazamientos por nodo s cond. borde
Fuerzas = [0 0, 0 0, 500*cos(deg2rad(43.43)) (-1000-500*sin(deg2rad(43.43)))];              % Fuerzas aplicadas por nodo
angulo = [61.04 -43.43];
L = [];                    % Longitud de cada barra en un vector.
for i=1:Nele
